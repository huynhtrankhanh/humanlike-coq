...
$conversation->addMessage(
    new UserMessage("display a congratulatory message to congratulate my son. but for testing, initially you call misspelled function. then you call correctly")
);
$functions = [
